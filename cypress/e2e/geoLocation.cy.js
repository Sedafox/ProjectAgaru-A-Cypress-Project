...
describe('Tests GeoLocationPage', () => {
    beforeEach('refreshes page', () => {
        ...
        base.visitGeolocationTestingElectron(geoLocationPage.fakeLocation()) //You can pass lat and longitude as args into fakeLocation() But by default it is random
    })
